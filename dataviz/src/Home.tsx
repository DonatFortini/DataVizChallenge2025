import { useState, useEffect, Suspense, useRef, useMemo, forwardRef } from 'react';
...
function ModelScene({ fallback }: { fallback?: React.ReactNode }) {
  return (
  ...
  return (
    <div className="relative bg-white min-h-[300vh]">
      ...
      <div
        ...
        style={{ zIndex: 5 }}
      >
        <ModelScene fallback={<mesh><boxGeometry /><meshStandardMaterial color="red" /></mesh>} />
      </div>
